    ...
    return (
        <div className="px-5 mt-6 pb-10 space-y-6">
            ...
            <div className="space-y-3">
                {announcements.map((a) => (
                    <div key={a.id} className="bg-white p-4 rounded-2xl border border-slate-100 flex justify-between items-start">
                        <div>
                            <p className="text-xs font-black text-[#0D2F5C] uppercase">{a.title}</p>
