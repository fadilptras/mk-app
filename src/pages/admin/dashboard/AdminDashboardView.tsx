    ...
    <div className="px-5 mt-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div
          ...
          className="bg-white p-5 rounded-3xl border border-slate-100 shadow-[0_2px_10px_rgba(13,47,92,0.02)] active:scale-95 transition-all cursor-pointer"
        >
          <p className="text-[10px] font-bold text-[#7A93B5] uppercase tracking-widest mb-1">
            Total Unit Kamar
          </p>
          <p className="text-3xl font-black text-blue-600">{rooms.length}</p>
          <span className="text-[9px] font-black text-blue-400 uppercase mt-2 block">
            Kelola Kamar →
          </span>
        </div>
        <div
        ...
        >
          ...
          <span className="text-[9px] font-black text-emerald-400 uppercase mt-2 block">
            Kelola Penghuni →
          </span>
        </div>
      </div>
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-[0_2px_10px_rgba(13,47,92,0.02)] space-y-3">
        <p className="text-[10px] font-bold text-[#7A93B5] uppercase tracking-widest">
          Okupansi Kamar
        </p>
        <div className="flex gap-4">
          <div>
            <p className="text-xs text-slate-500 font-medium">Terisi</p>
            <p className="text-lg font-black text-[#0D2F5C]">
              {loading ? "--" : terisiCount} Unit
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg font-black text-[#0D2F5C]">
              {loading ? "--" : kosongCount < 0 ? 0 : kosongCount} Unit
            </p>
          </div>
        </div>
      </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-black text-[#0D2F5C] line-clamp-1 max-w-[180px]">
                        {report.description}
                      </p>
                      <span className="text-[9px] font-bold text-[#7A93B5] uppercase tracking-wider block mt-0.5">
                        {report.category}
                      </span>
                    </div>
                  </div>
