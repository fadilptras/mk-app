...
export default function DetailBayarView() {
  ...
  // Fungsi Export / Unduh Gambar PNG menggunakan html2canvas
  ...
  // Tentukan warna status untuk icon dan text utama
  ...
  return (
    <div className="min-h-screen bg-[#BFDDF0] font-sans text-gray-800 overflow-x-hidden relative">
      <div className="max-w-md mx-auto relative min-h-screen bg-[#BFDDF0] flex flex-col pb-6">
        ...
        {isExporting && (
          <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex flex-col items-center justify-center text-white">
            ...
            <h2 className="text-sm font-bold tracking-wide">Menyiapkan Gambar Struk...</h2>
          </div>
        )}
        ...
        {/* ============================================================== */}
        {/* DESAIN TIKET/RESI DIGITAL PREMIUM (TAMPIL DI LAYAR HP)        */}
        {/* ============================================================== */}
        <div className="px-5 pt-8 pb-6 flex-1">
          ...
          <div className="relative bg-white rounded-3xl shadow-xl shadow-indigo-900/10 overflow-hidden mx-auto w-full max-w-[360px]">
            ...
            {/* BAGIAN ATAS TIKET: STATUS & NOMINAL */}
            <div className="px-6 pt-8 pb-6 text-center bg-white relative">
              {/* Ikon Check/Jam Pasir Besar */}
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 border-[4px] border-white shadow-md z-10 relative ${
                isPaid ? 'bg-emerald-500 text-white' : 
                isPending ? 'bg-amber-400 text-white' : 'bg-rose-500 text-white'
              }`}>
                {isPaid ? (
                  ...
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                ) : (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" /></svg>
                )}
              </div>
            ...
            {/* BAGIAN BAWAH TIKET: RINCIAN METADATA */}
            <div className="px-6 pt-6 pb-8 bg-gray-50/50">
              <div className="space-y-4">
                
                <div className="flex justify-between items-center text-xs">
                  <span className="text-gray-500 font-medium">Nomor Referensi</span>
                  <span className="font-mono font-bold text-gray-800">MK-{detailTagihan?.id.split('-')[0].toUpperCase()}</span>
                </div>
                <div className="flex justify-between items-center text-xs">
                ...
                {detailTagihan?.bukti_transfer && (
                  <div className="pt-2">
                    <div 
                      className="flex items-center justify-between bg-white border border-gray-200 p-2.5 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors shadow-sm"
                      onClick={() => window.open(detailTagihan.bukti_transfer, '_blank')}
                      title="Klik untuk melihat struk asli"
                    >
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-indigo-50 rounded-lg flex items-center justify-center text-indigo-500">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" /></svg>
                        </div>
          ...
          {/* Akhir Container Tiket */}
          
        </div>

        {/* TOMBOL DOWNLOAD INVOICE (Diluar Kartu) */}
      ...
      {/* ========================================================= */}
      {/* AREA TERSEMBUNYI KHUSUS UNTUK CONVERT KE GAMBAR (PNG) */}
      {/* Komponen ini yg diexport oleh html2canvas */}
      {/* ========================================================= */}
