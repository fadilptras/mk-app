...
export default function FormKontrakView() {
  ...
  // Kalkulasi Tarif Dasar komponen kamar otomatis
  ...
  // Blok pengaman/proteksi di level Router Klien (jika user memaksa nembak URL)
  useEffect(() => {
  ...
  const handleSimpan = async () => {
    ...
    if (success) {
      ...
      navigate('/kontrak'); // Dialihkan balik secara instan ke dashboard kontrak
    }
  };
    ...
    <div className="min-h-screen bg-[#BFDDF0] font-sans text-gray-800 pb-10">
      <div className="max-w-md mx-auto bg-[#BFDDF0] min-h-screen shadow-inner">
        ...
        <div className="p-5 space-y-5">
          ...
          {/* DETAIL INFO KONTRAK YANG AKAN / SEDANG BERAKHIR */}
          {activeContract && (
            <div className="bg-gradient-to-br from-slate-800 to-indigo-950 text-white rounded-3xl p-5 shadow-xl space-y-3.5">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h4 className="text-sm font-black font-mono mt-0.5">REG-{activeContract.id.split('-')[0]}</h4>
                </div>
