...
export default function LaporView() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status.toUpperCase()) {
      ...
      case "IN_PROGRESS":
        return (
          <span className="text-[9px] font-black bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-md uppercase tracking-wider">
            Diproses
          </span>
        );
      case "RESOLVED":
        return (
          <span className="text-[9px] font-black bg-emerald-50 text-emerald-700 border border-emerald-200 px-2 py-0.5 rounded-md uppercase tracking-wider">
            Selesai
          </span>
        );
      case "REJECTED":
        return (
          <span className="text-[9px] font-black bg-rose-50 text-rose-700 border border-rose-200 px-2 py-0.5 rounded-md uppercase tracking-wider">
            Ditolak
          </span>
        );
      default:
        return (
          <span className="text-[9px] font-black bg-amber-50 text-amber-700 border border-amber-200 px-2 py-0.5 rounded-md uppercase tracking-wider">
            Menunggu
          </span>
        );
    }
        ...
        <div className="p-6">
          ...
          <div className="bg-white border border-gray-100 rounded-[28px] p-5 shadow-[0_12px_40px_rgba(0,0,0,0.03)] flex gap-4 items-start mb-6">
            ...
            <div className="space-y-1 mt-0.5">
              ...
              <p className="text-[10px] font-bold text-gray-500 leading-relaxed uppercase">
                Sampaikan kendala fasilitas kamar atau area bersama agar segera
                ditindaklanjuti secara langsung oleh Admin.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-100/80 p-1 rounded-2xl flex items-center mb-6">
            ...
            >
              ...
              {history.length > 0 && (
                <span
                  className={`w-4 h-4 rounded-full flex items-center justify-center text-[8px] font-black ${activeTab === "history" ? "bg-indigo-600 text-white" : "bg-gray-300 text-white"}`}
                >
                  {history.length}
                </span>
              )}
                ...
                <form onSubmit={handleSubmit} className="space-y-5 mt-2">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="Masalah Air / Plambing">
                          Masalah Air / Plambing
                        </option>
                        <option value="Gangguan Jaringan WiFi">
                  ...
                  <div>
                    ...
                    <div className="w-full p-5 border-2 border-dashed border-gray-200 rounded-[20px] bg-gray-50/50 flex flex-col items-center justify-center hover:bg-indigo-50/50 hover:border-indigo-300 transition-all cursor-not-allowed group">
                      ...
                      <span className="text-[10px] font-black text-gray-600 group-hover:text-indigo-600 uppercase tracking-wider">
                        Unggah Foto Kendala
                      </span>
                      <span className="text-[8px] font-bold text-gray-400 mt-0.5 uppercase">
                        (Segera Hadir)
                      </span>
                    </div>
                  </div>
