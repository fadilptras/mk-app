...
export default function ListrikView() {
  ...
  const fetchMeterData = async () => {
    try {
      ...
      // Mengambil data kamar yang terikat dengan user[cite: 11]
      const { data, error: fetchError } = await supabase
        .from("rooms")
        .select("meter_number, meter_name, created_at")
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="bg-red-50 border border-red-200 p-5 rounded-[32px] mt-4 text-center">
              <p className="text-[11px] font-bold text-red-800 leading-relaxed uppercase mb-3">{error}</p>
              <button
            ...
            <>
              ...
              <div className="bg-white border border-gray-100 rounded-[28px] p-5 shadow-[0_12px_40px_rgba(0,0,0,0.03)] flex gap-4 items-start mb-6">
                ...
                <div className="space-y-1 mt-0.5">
                  ...
                  <p className="text-[10px] font-bold text-gray-500 leading-relaxed uppercase">
                    Pastikan nama yang tertera saat pembelian token sesuai dengan data di bawah ini.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[32px] p-6 shadow-[0_12px_40px_rgba(0,0,0,0.03)] border border-gray-100 text-center relative overflow-hidden mb-8">
                ...
                <div className="mb-5">
                  ...
                  <div className="bg-indigo-50 py-3.5 px-4 rounded-2xl border border-indigo-200 font-mono font-black text-xl text-indigo-900 tracking-wider">
                ...
                <div className="space-y-5">
                  ...
                  {/* PENAMBAHAN ID REFERENSI LISTRIK (opsional sebagai ID Laporan/Meteran) */}
                  <div className="text-[9px] font-black text-gray-400 uppercase tracking-widest">
                    REF ID: {generateRefID('tagihan', meterInfo.meter_number, meterInfo.created_at)}
                  </div>
                </div>
                ...
                <div className="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <StepGuide
                      number="3"
                      title="Input Fisik"
                      description="Ketik 20 digit angka pada keypad meteran fisik di depan kamar, lalu tekan tombol 'Enter'."
